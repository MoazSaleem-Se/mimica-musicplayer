...
public final class PlaylistDao_Impl implements PlaylistDao {
  ...
  public PlaylistDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfPlaylistEntity = new EntityInsertionAdapter<PlaylistEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `playlists` (`id`,`name`,`createdAt`,`songCount`) VALUES (nullif(?, 0),?,?,?)";
      }
  ...
  @Override
  public Object getAllPlaylistsList(final Continuation<? super List<PlaylistEntity>> $completion) {
    final String _sql = "SELECT * FROM playlists ORDER BY createdAt DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
      ...
      public PlaylistEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final int _tmpSongCount;
            _tmpSongCount = _cursor.getInt(_cursorIndexOfSongCount);
            _result = new PlaylistEntity(_tmpId,_tmpName,_tmpCreatedAt,_tmpSongCount);
          } else {
            _result = null;
          }
          return _result;
